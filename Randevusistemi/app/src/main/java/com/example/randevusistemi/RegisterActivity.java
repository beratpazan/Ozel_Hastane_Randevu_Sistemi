    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Database db= new Database(getApplicationContext(),"Randevusistemi",null,1);
                if (username.length() == 0 || password.length() == 0) {
                    Toast.makeText(getApplicationContext(), "Bu Alanı Doldurunuz", Toast.LENGTH_SHORT).show();
                }
                else {
                    if (password.compareTo(confirm) == 0) {
                        ...
                        Toast.makeText(getApplicationContext(), "Şifre en az 8 karakterden oluşmalı ve harf,rakam,sembol içermelidir", Toast.LENGTH_SHORT).show();
                    }
                    }
            }
        });
